...
root = Tk()
root.title('Simple calcutaor CS 115U')

entry_value = Entry(width=35, borderwidth=5)
entry_value.grid(row=0, column=0, columnspan=3, padx=10, pady=10)
...
def button_equal():
    ...
    if  math == 'addition':
        entry_value.insert(0, f_num + int(second_number))
    if  math == 'subtraction':
        entry_value.insert(0, f_num - int(second_number))
